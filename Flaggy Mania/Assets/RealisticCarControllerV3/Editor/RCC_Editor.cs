...
public class RCC_Editor : Editor {
	...
	private void SteeringTab() {
		...
		EditorGUILayout.PropertyField(serializedObject.FindProperty("useSteeringSmoother"), new GUIContent("Use Steering Smoother", "Applies Steering smoother."));

		if (carScript.useSteeringSmoother)
